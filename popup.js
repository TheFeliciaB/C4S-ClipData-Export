...
// Event listener for text export.
...
Clip Description: ${data.clipDescription}`;
    const fileName = (data.clipTitle.trim() || "export") + ".txt";
...
document.getElementById("exportCSV").addEventListener("click", function() {
  getFormData(data => {
    const header = ["Store ID", "Clip Title", "Clip Category", "Clip Name", "Clip Time", "Clip Price", "Clip ID", "Clip Date", "Clip Description"];
    const row = [
    ...
    const fileName = (data.clipTitle.trim() || "export") + ".csv";
...
<StoreID>${escapeXML(data.clipStore)}</StoreID>
  ...
  ${data.clipDescription}
    ...
    const fileName = (data.clipTitle.trim() || "export") + ".xml";
...
<body>
  ...
  <table>
    ...
    const fileName = (data.clipTitle.trim() || "export") + ".html";
